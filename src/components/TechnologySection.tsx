...
const TechnologySection: React.FC = () => {
  const techFeatures = [
    {
      ...
      details: ['High availability', 'Auto-scaling', 'Health monitoring', 'Global distribution']
    },
    {
      icon: Shield,
      title: 'SIP Security',
      description: 'Enterprise-grade security for all communications',
      details: ['TLS encryption', 'SIP over TLS', 'Fraud detection', 'Access control']
    },
    {
      icon: Zap,
      title: 'HA/DR',
      description: 'High availability and disaster recovery systems',
      details: ['99.99% uptime', 'Automatic failover', 'Data replication', 'Backup systems']
    }
  ];

  const certifications = [
    { name: 'ISO 27001', description: 'Information Security Management', logo: '🏆' },
    { name: 'SOC 2 Type II', description: 'Security & Availability Controls', logo: '🛡️' },
    { name: 'VAPT', description: 'Vulnerability Assessment & Penetration Testing', logo: '🔒' }
  ];
  ...
  return (
    <section id="technology" className="py-24 bg-gray-50 dark:bg-gray-800 relative overflow-hidden">
      {/* Background */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Enterprise-grade infrastructure built for scale, security, and reliability with 
            industry-leading compliance and performance standards.
          </p>
        </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="relative h-80 bg-gradient-to-br from-emerald-50 to-cyan-50 dark:from-gray-800 dark:to-purple-900 rounded-2xl overflow-hidden">
              ...
              <svg className="absolute inset-0 w-full h-full" style={{ pointerEvents: 'none' }}>
                ...
                <line x1="50%" y1="20%" x2="50%" y2="40%" stroke="url(#lineGradient)" strokeWidth="2" />
                <line x1="50%" y1="40%" x2="50%" y2="64%" stroke="url(#lineGradient)" strokeWidth="2" />
                <line x1="50%" y1="64%" x2="50%" y2="84%" stroke="url(#lineGradient)" strokeWidth="2" />
              </svg>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {techFeatures.map((feature, index) => (
            <div key={index} className="bg-white dark:bg-gray-900 rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="w-16 h-16 bg-gradient-to-r from-emerald-500 to-cyan-500 dark:from-cyan-500 to-purple-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl p-12 shadow-2xl mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {certifications.map((cert, index) => (
              <div key={index} className="text-center group">
                <div className="w-24 h-24 bg-gradient-to-r from-emerald-500 to-cyan-500 dark:from-cyan-500 to-purple-500 rounded-full mx-auto mb-6 flex items-center justify-center text-4xl shadow-2xl group-hover:scale-110 transition-transform duration-300">
                  {cert.logo}
                </div>
                <h4 className="text-xl font-bold text-gray-800 dark:text-white mb-2">{cert.name}</h4>
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {architectureComponents.map((component, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-900 rounded-xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 dark:border-gray-700"
              >
